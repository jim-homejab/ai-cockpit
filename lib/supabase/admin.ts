...
//  - the MCP and Pipedream Vault bridges, after session auth, to call
//    service-role-only secret RPCs. Metadata still uses the session client;
//    decrypted credentials never cross the API boundary.
